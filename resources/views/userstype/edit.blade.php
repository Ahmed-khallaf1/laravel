...
<div class="container">
<h2>UsersType</h2>
<form  method="post"  action="{{ url('/userstype/'.$data[0]->id) }}"  enctype ="multipart/form-data">
...
<input type="text"  name="name" value="{{ $data[0]->name }}" class="form-control" id="exampleInputName" aria-describedby="" placeholder="Enter title">
</div>
