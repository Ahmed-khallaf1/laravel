...
<div class="container">
<h2>appointments</h2>
<form  method="post"  action="{{ url('/appointments/'. $data[0]->id) }}"  enctype ="multipart/form-data">
...
<input type="time"  name="app_from" value="{{ $data[0]->app_from }}"  class="form-control" id="exampleInputName" aria-describedby="" placeholder="Enter app_from">
</div>


<div class="form-group">
<label for="exampleInputEmail1">app_to</label>
<input type="time" name="app_to" value="{{ $data[0]->app_to }}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter app_to">
</div>
